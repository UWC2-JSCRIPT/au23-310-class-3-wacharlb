...
const attack = function(attacker, defender, baseDamage, variableDamage) {
...
console.log(`attack1: ${attack(player1, player2, 1, 4)}`)

// 3. Refactor attack function to an arrow function.  Comment out function above.

const attack2 = (attacker, defender, baseDamage, variableDamage) => {
  const randomDamage = Math.floor(Math.random() * (variableDamage + 1))
  console.log(randomDamage)
  const totalDamage = baseDamage + randomDamage
  defender.health -= totalDamage
...
console.log(`attack2: ${attack2(player1, player2, 1, 4)}`)
